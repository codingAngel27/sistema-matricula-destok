...
public class DlgBuscarAlumno extends JDialog implements ActionListener {
	...
	protected void actionPerformedBtnBusqueda(ActionEvent e) {
		...
		if(rdbtnAsignatura.isSelected()) {
			tipoConsulta=1;
			buscarlistener.buscarAlumno(dato, tipoConsulta);
	...
	interface BuscarListener {
		void buscarAlumno(String dato, int tipoConsulta);
